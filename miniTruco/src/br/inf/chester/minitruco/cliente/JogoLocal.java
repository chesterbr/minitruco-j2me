...
public class JogoLocal extends Jogo {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#run()
	 */
	public void run() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#jogaCarta(br.inf.chester.minitruco.cliente.Jogador,
	 *      br.inf.chester.minitruco.cliente.Carta)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#decideMao11(br.inf.chester.minitruco.cliente.Jogador,
	 *      boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#aumentaAposta(br.inf.chester.minitruco.cliente.Jogador)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#respondeAumento(br.inf.chester.minitruco.cliente.Jogador,
	 *      boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#getCartaDaMesa()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.inf.chester.minitruco.cliente.JogoGenerico#atualizaSituacao(br.inf.chester.minitruco.cliente.SituacaoJogo,
	 *      br.inf.chester.minitruco.cliente.Jogador)
	 */
