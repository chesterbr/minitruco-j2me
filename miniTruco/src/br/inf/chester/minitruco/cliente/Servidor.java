 ...
 * 
 */
public class Servidor extends Canvas implements Runnable, CommandListener {
	...
	private static final Command atualizarListaCommand = new Command("Atualizar",
			Command.SCREEN, 3);
	 ...
	 */
	public Servidor(String endereco, MiniTruco midlet) {
	...
	private Sala sala = new Sala(this);
	...
	public void abortaJogoAtual() {
		if (jogo != null) {
			jogo.abortaJogo(jogo.getJogadorHumano());
			jogo = null;
			display.setCurrent(this);
		}
	}
